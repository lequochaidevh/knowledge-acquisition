...
int main() {
    ...
    // Layer 1 (Hidden): 3 Inputs -> 4 Hidden Features (Extracts complex patterns)
    DenseLayer layer1(3, 14);
    // Layer 2 (Output): 4 Hidden Features -> 1 Output Prediction (Final decision)
    ...
    Tensor2D final_pred = layer2.forward(out_h1_act);
