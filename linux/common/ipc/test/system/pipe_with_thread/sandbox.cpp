...
int main() {
    ...
    std::thread server_thread_template([&request_pipe_path]() {
        // Init Server
        PipeServer server(request_pipe_path, PipeServer::ServerMode::Feedback);
    ...
    std::thread client01_thread_template([&request_pipe_path]() {
        // Init client
        PipeClient client(request_pipe_path, "client_alpha", PipeClient::ClientMode::CheckLose);
    ...
    std::thread client02_thread_template([&request_pipe_path]() {
        ...
        PipeClient client(request_pipe_path, "client_alpha_02", PipeClient::ClientMode::CheckLose);
